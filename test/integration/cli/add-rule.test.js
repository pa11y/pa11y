...
describe('CLI add-rule', function() {
	let pa11yResponse;

	describe('when the `--add-rule` flag is set to an issue code not in the current standard', function() {
		...
		it('detects and outputs issues with the specified code', function() {
