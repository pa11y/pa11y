...
You could also write a custom `beforeScript` [PhantomJS hook](http://phantomjs.org/api/webpage/handler/on-callback.html) to capture an [emitted Angular view load event](https://github.com/angular-ui/ui-router/wiki#view-load-events). 
