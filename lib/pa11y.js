 ...
 * @param {Object} [options] - Options to change the way tests run.
 * @param {Object} [state] - The state object which contains a reference to the current browser page
 ...
 * @private
 * @param {Object} [options] - Options to change the way tests run.
 * @param {Object} [state] - The state object which contains a reference to both the current
 *   browser and current page
...
async function runPa11yWithOptions(options, state) {
	...
	const results = await state.page.evaluate(runOptions => {
